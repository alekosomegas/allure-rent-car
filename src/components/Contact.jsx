  ...
  async function handleSubmit(event) {
    ...
    await fetch("api/mail", {
      ...
      .then(() => {
        setIsLoading(false);
        alert(
          "Thank you! We have received your message and an agent will contact you soon."
        );
      })
      .catch((e) => {
        console.log(e);
  ...
  return (
    <section className="flex flex-col md:flex-row">
      ...
      <div className="flex flex-col gap-3 w-1/3 bg-highlight1 p-4 max-md:w-full text-white">
        ...
        <div className="flex flex-row gap-2">
          ...
          <p className="">
            ...
            <br /> Zanna Complex Block 1 Shop 8, <br />
            Limassol, 4532
          </p>
        </div>
      </div>
      ...
      <form
        ...
        className="text-center w-1/3 bg-highlight1 p-4 max-md:w-full"
        action=""
      >
